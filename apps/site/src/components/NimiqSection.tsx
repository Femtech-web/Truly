    ...
    <section id="nimiq" className="nimiq-section">
      <Reveal className="shell nimiq-grid">
        <div className="nimiq-copy">
          ...
          <p>Nimiq Pay connects Truly to the learner—not to a password. Pair your Mac, unlock creator-made Paths with NIM, and keep your progress available from your phone.</p>
          <div className="nimiq-details">
            <div><b>Pair with a signature</b><span>Approve the exact Mac you want to connect.</span></div>
            <div><b>Unlock Paths with NIM</b><span>Wallet approval remains inside Nimiq Pay.</span></div>
            ...
            <div className="phone-screen">
              ...
              <div className="phone-content">
                ...
                <div className="phone-progress-card">
                  <div><span>NIM payments users can trust</span><b>1 / 3</b></div><div className="phone-progress"><i /></div><small>Learning now on Mac</small>
                </div>
                <div className="phone-section-head"><b>Paths</b><span>View all</span></div>
                <div className="phone-skill"><span className="skill-monogram">N</span><div><b>NIM payments users can trust</b><small>3 practical steps</small></div><strong>0.01 NIM</strong></div>
                <div className="phone-skill"><span className="skill-monogram skill-monogram--light">M</span><div><b>Build your first Nimiq Mini App</b><small>Continue learning</small></div><strong>Open</strong></div>
              </div>
